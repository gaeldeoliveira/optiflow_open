...
%  ---- Edit any properties of choice, like number of cores ---- %
    ...
    SC.airfoil_subdir             = 'probabilistic/data_rnd4/airfoils/';
    SC.feasible_airfoil_subdir    = 'probabilistic/data_rnd4/feasible_airfoils/';
...
CF_LoverD = cost_function('expected_mingled_LD_at_AoA');                                   % Initialize it and give it a name
CF_LoverD.cost_function_handle = @cost_function_max_expected_CL_over_expected_CD_mingled;  % Specify which function to use
...
CF_CFexceedance = cost_function('expected_tripped_LD_at_AoA');                               % Initialize it and give it a name
