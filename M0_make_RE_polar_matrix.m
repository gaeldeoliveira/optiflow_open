...
%% Make airfoil polar_mesh for DU18WP210-S00E35
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S00E35.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
...
%% Make airfoil polar_mesh for DU18WP210-S20E35
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S20E35.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
case_overview.xtr_top        =   0.05;              % set top    transition position for free
case_overview.xtr_bot        =   0.10;              % set bottom transition position for free
polar_mesh_trip = make_polar_mesh(case_overview); polar_mesh = polar_mesh_trip; %#ok<NASGU>
...
%% Make airfoil polar_mesh for DU18WP210-S40E35
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S40E35.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
case_overview.xtr_top        =   0.05;              % set top    transition position for free
case_overview.xtr_bot        =   0.10;              % set bottom transition position for free
polar_mesh_trip = make_polar_mesh(case_overview); polar_mesh = polar_mesh_trip; %#ok<NASGU>
...
%% Make airfoil polar_mesh for DU18WP210-S00E50
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S00E50.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
case_overview.xtr_top        =   0.05;              % set top    transition position for free
case_overview.xtr_bot        =   0.10;              % set bottom transition position for free
polar_mesh_trip = make_polar_mesh(case_overview); polar_mesh = polar_mesh_trip; %#ok<NASGU>
...
%% Make airfoil polar_mesh for DU18WP210-S20E50
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S20E50.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
case_overview.xtr_top        =   0.05;              % set top    transition position for free
case_overview.xtr_bot        =   0.10;              % set bottom transition position for free
polar_mesh_trip = make_polar_mesh(case_overview); polar_mesh = polar_mesh_trip; %#ok<NASGU>
...
%% Make airfoil polar_mesh for DU18WP210-S40E50
case_overview.filename       = 'rotor_integration/airfoil_families/DU-WP/DU18WP210-S40E50.air';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% Make rough polar
case_overview.xtr_top        =   0.05;              % set top    transition position for free
case_overview.xtr_bot        =   0.10;              % set bottom transition position for free
polar_mesh_trip = make_polar_mesh(case_overview); polar_mesh = polar_mesh_trip; %#ok<NASGU>
