function [u_z, u_r, u_mag] = vortex_line_induction_alfa6_fun(Gamma, Zr1, Rr1, Zr2, Rr2, delta, ellipke_tol, K, Zt, Rt)
...
for k = 1:K
    ...
    [u_z_k, u_r_k, ~] = vortex_ring_induction_alfa6_fun(Gamma/K, Zr_k, Rr_k, delta, ellipke_tol, Zt, Rt);
