...
% This function is a convenient was to all MEX() to compile a C/C++/F-Mex source
% file and catch errors.
...
% $JRev: R-v V:021 Sum:9drAC9S2n1AP Date:01-Mar-2014 12:07:33 $
...
if ~isempty(whichMex)
   ...
   if ~replace
      ...
      QuestReply = questdlg({['\bf', mfilename, ': ', SourceName, '\rm'], ...
         ...
         ['  ', TeXFirm(fullfile(SourcePath, mexName))], ''}, ...
