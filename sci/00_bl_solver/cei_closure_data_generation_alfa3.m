...
hk_range = [1 , linspace(1.4, 8, 20)];
% Set of Momentum Thickness Reynolds (Re_theta = rt)
rt_range = linspace(500, 200000, 10);
...
dataset_file = 'cei_closure_data_2.mat';  % Dataset filename
...
figure(4); plot(hk_range , cei_function(hk_range, 1000, 1), hk_range , cei_function(hk_range, 1000, 3.5) , hk_range , cei_function(hk_range, 5000, 6))
grid on; 
xlabel('hk - Shape Factor') ; ylabel('C_{ei} - Energy Interaction Coefficient');
