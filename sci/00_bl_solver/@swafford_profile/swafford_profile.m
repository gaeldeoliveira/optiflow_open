classdef swafford_profile < handle
    ...
    methods
        ...
        function update_hk_rt_pair(SP, hk, rt)
            ...
            if or(not(SP.hk==hk) , not(SP.rt==rt))
        ...
        function update_dependent_variables(SP)
            ...
            % SP.cf = SP.cft_swafford(SP.hk, SP.rt);         % Swafford profile generation Cf closure. See method description for more details on why this is the right choice!
        ...
        function cf = cft_swafford(SP, hk, rt)
