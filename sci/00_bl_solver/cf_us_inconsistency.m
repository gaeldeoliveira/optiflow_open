...
%% Inputs
ue_over_nue = 0.5e6;                  % Reynolds Number Proxy
t           = 0.005;                 % Theta - Momentum Thickness
...
% Kinematic Shape Factor (hk==h for msq=0)
[ hk, hk_h, hk_msq  ] = hkin( h, msq)
% Energy Shape Factor (theta* / theta)
[ hs, hs_hk, hs_rt, hs_msq  ] = hst( hk, rt, msq);
% Skin Friction (Swafford)
[ cf, cf_hk, cf_rt, cf_msq  ] = cft( hk, rt, msq);
% Slip Speed (Rfoil)
[ us, us_h, us_hk, us_hs] = usg(h, hk, hs);
