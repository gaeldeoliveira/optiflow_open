...
H12                 = 1.4;                        % [--]  Shape Factor 

% Define Forcing Terms
xi_vector   = linspace(0, 0.1, 100);        % xi  = X  / L          Adimensional Stance       
