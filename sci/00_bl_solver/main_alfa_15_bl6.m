...
alpha_str='10';  % angle of attack considered
act_str='LE';  % Trailing or Leading Edge actuator
U_str='20';    % Wind Speed
...
BL_cf.set_equilibrium_initial_conditions(t0_on, h0_on);          % Initial Shear Stress Coefficient determined as if BL was in equilibrium (which more less never true!!!)
...
BL_cf.integrate_ODE( x0_on , xend);
