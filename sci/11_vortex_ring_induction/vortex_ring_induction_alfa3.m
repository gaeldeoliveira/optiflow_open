...
% Compute Induction
[u_x, u_y, u_mag_xy, u_r, u_z, u_mag] = vortex_ring_induction_alfa3_fun(Gamma, R, delta, ellipke_tol, t_x, t_y);
...
% Now make a mesh
[t_x_mesh , t_y_mesh] = meshgrid(linspace(-abs(t_x),abs(t_x)), linspace(-abs(t_y),abs(t_y)));
% And compute induction over it
[u_x_mesh, u_y_mesh, u_mag_xy_mesh, u_r_mesh, u_z_mesh, u_mag_mesh] = vortex_ring_induction_alfa3_fun(Gamma, R, delta, ellipke_tol, t_x_mesh, t_y_mesh);
% Now plot
surf(t_x_mesh , t_y_mesh, u_r_mesh)
