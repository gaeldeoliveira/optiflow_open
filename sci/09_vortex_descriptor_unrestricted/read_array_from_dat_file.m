function ZPGyaw0baseo = read_array_from_dat_file(filename, startRow, endRow)
...
%
% Example:
%   ZPGyaw0baseo = importfile('ZPG_yaw0_base_o.dat', 4, 219);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/01/27 20:03:49
...
formatSpec = '%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%[^\n\r]';
