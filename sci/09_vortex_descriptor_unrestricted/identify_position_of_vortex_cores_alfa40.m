...
% % Header copied from:
%       sct_passive_scalar_convection_alfa4_3AF_picture_mod_alfa39ZPG
...
state_05h = load('20180730T161639/matfiles/full_state_asy_5h.mat' ); y_num(1) = state_05h.state.y_v; z_num(1) = state_05h.state.z_v;
state_06h = load('20180730T161639/matfiles/full_state_asy_6h.mat' ); y_num(2) = state_06h.state.y_v; z_num(2) = state_06h.state.z_v;
state_07h = load('20180730T161639/matfiles/full_state_asy_7h.mat' ); y_num(3) = state_07h.state.y_v; z_num(3) = state_07h.state.z_v;
state_08h = load('20180730T161639/matfiles/full_state_asy_8h.mat' ); y_num(4) = state_08h.state.y_v; z_num(4) = state_08h.state.z_v;
state_09h = load('20180730T161639/matfiles/full_state_asy_9h.mat' ); y_num(5) = state_09h.state.y_v; z_num(5) = state_09h.state.z_v;
state_10h = load('20180730T161639/matfiles/full_state_asy_10h.mat'); y_num(6) = state_10h.state.y_v; z_num(6) = state_10h.state.z_v;
% And (semi)automatically
y_num_full = zeros(1,49);
z_num_full = zeros(1,49);
for n_num=1:length(y_num_full)
   state_tmp = load(['20180730T161639/matfiles/full_state_asy_', num2str(n_num), 'h.mat' ]); 
   y_num_full(n_num) = state_tmp.state.y_v; 
   z_num_full(n_num) = state_tmp.state.z_v; 
end
state_tmp = load(['20180730T161639/matfiles/full_state_asy_', '-0.5', 'h.mat' ]); 
...
figure(406)
subplot(221)
h_06  = plot(y_line, w_line06      /state.ue, 'k-'); hold on
...
subplot(222)
h_10  = plot(y_line, w_line10      /state.ue, 'k-'); hold on
...
print ('-deps', ['spanwise_induction_ZPG_extrapolated.eps']) %#ok<NBRAK>
