function expected_values = probabilistic_polar_tensor_interpolator_explicit(polar_tensors, interpolated_tensor, alpha, Re, tc, std_alpha_deg)
% Derived from probabilistic_polar_tensor_interpolator
