function [RES_axi, RES_tan, BD, BR] = bogo2_alfa7_BEMsolver(BC)
        % % Make discretization
        [~, ~, BD, ~] = bogo2_alfa7_RES_fun(BC, [], [], []);
        % Extract initial guess
        a_serial_0 = serialize_axi_tan(BD.a_axi_0, BD.a_tan_0);
        % Make serial function wrapper
        res_serial_fun = @(a_serial) bogo2_alfa7_RES_serialfun(BC, BD, a_serial);
        ...
        [RES_axi, RES_tan, BD, BR] = bogo2_alfa7_RES_fun(BC, BD, a_axi, a_tan);
end