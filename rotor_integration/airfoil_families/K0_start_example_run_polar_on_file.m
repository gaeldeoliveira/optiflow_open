...
%% Add needed paths
addpath ../optiflow_release/src/
addpath ../optiflow_release/user_src/
addpath ../optiflow_release/dev/


%% Inputs
% % Filename
case_overview.filename       = 'FFA/FFAw3211.txt';   % Name of airfoil file (can also have folders, absolute or from cd (./))
% % Polar conditions
