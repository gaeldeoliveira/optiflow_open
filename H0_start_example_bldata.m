...
%  ---- Edit any properties of choice ---- %
    ...
    SP1.Re = 1000000;                                               % Reynolds Number (NaN means inviscid)
...
GM.options_structure.PopulationSize=150;
GM.options_structure.Generations=30;
...
results_free = GM.last_results;
save([mfilename(), '-results-free-' , datestr(now, 'yyyymmddTHHMMSS')], 'results_free');
save([mfilename(), '-fullcase-free-', datestr(now, 'yyyymmddTHHMMSS')]);
