...
initialization_file                 = 'run_over_database_alfa19_initialization_20180214T114723.mat';
...
if flag_postprocess == true
    ...
    legend('run-over-database-alfa18', 'Location', 'South')
    print(['./fig/_0_title' , datestr(now(), 30)], '-dpdf')
    savefig(['./fig/_0_title' , datestr(now(), 30)]);
