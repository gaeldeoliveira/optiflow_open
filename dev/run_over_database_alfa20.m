...
flag_gradient_descent_deterministic = true;
flag_gradient_descent_stochastic    = false;
flag_postprocess                    = false;

% Define name of key files
initialization_file                 = 'run_over_database_alfa20_initialization_20180221T172918.mat';
database_file                       = './data/experimental/EDB_317665fb-cd39-4321-b8cf-124f15d6f060.mat';
rng_state_file                      = 'run_over_database_alfa19_rngstate_20180214T121322.mat';
...
if flag_initialization == true    
    ...
    % cu
    EC_cell_full = EDB.EC_cell;
    EDB.EC_cell = [EDB.EC_cell(1:134), EDB.EC_cell(136:end)];
...
if flag_gradient_descent_deterministic == true
    ...
    [xgrad,fval_grad,exitflag_grad,output_grad] = fmincon(min_fun_handle_full_train_set ,GFW.x_0,[],[],[],[],GFW.x_lb,GFW.x_ub, [], options_grad);
