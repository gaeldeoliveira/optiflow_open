% Perform some processing for Torque2018 from alfa17 intermediate results!
% (retrieved from log of Nsira/Azure Sudo 1 machine (32 cores!))
...
% Intermediate processing! Skip test:
% Try function handle
...
% Intermediate processing! Skip optimization:
% [xgrad,fval_grad,exitflag_grad,output_grad] = fmincon(min_fun_handle ,GFW.x_0,[],[],[],[],GFW.x_lb,GFW.x_ub, [], options_grad);
% Intermediate processing! Fill in result from log (intermediate_result_log_alfa17.m)
% STD:20171204T032258:global_function_wrapper> --- New simulation profile requested ---
% STD:20171204T032258:global_function_wrapper>                   n_log = 46
% STD:20171204T032258:global_function_wrapper>                     n_x = 1
% STD:20171204T032258:global_function_wrapper>  scalar_accuracy_metric = 1.5782
% STD:20171204T032258:global_function_wrapper>                       x = 0.9405      1.1575      1.0514      1.0589      1.0271     0.97419      1.0123       1.024
xgrad = [0.9405, 1.1575, 1.0514, 1.0589, 1.0271, 0.97419, 1.0123, 1.024];
...
print(['./fig/0_title_' , datestr(now(), 30)], '-dpdf')
savefig(['./fig/0_title_', mfilename() , datestr(now(), 30)]);
