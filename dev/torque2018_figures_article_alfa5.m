...
plot(ap_0_alfa21_alpha_mixed , ap_0_alfa21_cl_mixed);
plot(ap_alfa21_alpha_mixed , ap_alfa21_cl_mixed);
legend('LTT [  ]', 'Original Rfoil', 'Learned Rfoil', 'Location', 'NorthWest');
axis([-5 15 -0.2 1.4]);
...
legend('Previous Closure', 'DNS [Vinuesa et al.]', 'Learned Closure alfa21', 'Learned Closure alfa17');
...
legend('Previous Closure', 'Learned Closure alfa21', 'Learned Closure alfa17');
xlabel('H_k - Kinematic Shape Factor');
