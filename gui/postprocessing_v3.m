...
function varargout = postprocessing_v3(varargin)
% POSTPROCESSING_V3 M-file for postprocessing_v3.fig
%      POSTPROCESSING_V3, by itself, creates a new POSTPROCESSING_V3 or raises the existing
%      singleton*.
%
%      H = POSTPROCESSING_V3 returns the handle to a new POSTPROCESSING_V3 or the handle to
%      the existing singleton*.
%
%      POSTPROCESSING_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in POSTPROCESSING_V3.M with the given input arguments.
%
%      POSTPROCESSING_V3('Property','Value',...) creates a new POSTPROCESSING_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before postprocessing_v3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to postprocessing_v3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help postprocessing_v3

% Last Modified by GUIDE v2.5 13-Nov-2017 16:02:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @postprocessing_v3_OpeningFcn, ...
                   'gui_OutputFcn',  @postprocessing_v3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before postprocessing_v3 is made visible.
function postprocessing_v3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to postprocessing_v3 (see VARARGIN)

% Choose default command line output for postprocessing_v3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes postprocessing_v3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = postprocessing_v3_OutputFcn(hObject, eventdata, handles) 
