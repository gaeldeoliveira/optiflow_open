...
FFAw3211_free = load('rotor_integration/airfoil_families/FFA/FFAw3211_polar_mesh_free.mat');
...
polar_mesh_cell{1} = FFAw3211_free.polar_mesh;
...
% Save to file
save('rotor_integration/airfoil_families/FFA/FFA_freeC.mat', 'polar_tensors')

%% Tripped case
% Load FFA airfoil polars (for free case)
FFAw3211_trip = load('rotor_integration/airfoil_families/FFA/FFAw3211_polar_mesh_trip.mat');
...
% And corresponding cell array
polar_mesh_cell = cell(4,1);
polar_mesh_cell{1} = FFAw3211_trip.polar_mesh;
...
% Save to file
save('rotor_integration/airfoil_families/FFA/FFA_tripC.mat', 'polar_tensors')
