...
[unique_monotonic_xun, unique_index_monotonic_xun, ~] = unique(monotonic_xun);
...
unique_sorted_bldata_cfx = base_bldata_cfx(unique_index_monotonic_xun,unique_sorting_index_aoa);
unique_sorted_bldata_cpx = base_bldata_cpx(unique_index_monotonic_xun,unique_sorting_index_aoa);
unique_sorted_bldata_dst = base_bldata_dst(unique_index_monotonic_xun,unique_sorting_index_aoa);
unique_sorted_bldata_tet = base_bldata_tet(unique_index_monotonic_xun,unique_sorting_index_aoa);

% Create interpolation grids (independent variables)
[aoa_grid, xun_grid] = meshgrid(unique_sorted_aoa, unique_monotonic_xun);
...
bldata.xun_range   = unique_monotonic_xun;
