function [sc , alpha_design]= cost_function_max_expected_CL_over_expected_CD_v2(parameters , experiments_results)
...
if strcmp(class(ap) , 'aerodynamic_polar') %#ok<STISA>
    ...
    if alpha_range_width < 6 * std_alpha_deg
        ...
        [max_cl_expected_over_cd_expected ,  i_max_cl_expected_over_cd_expected] = max(cl_expected_over_cd_expected);
        % Return alpha_design for processing by caller if he desires
        alpha_design = alpha_range_sanitized(i_max_cl_expected_over_cd_expected);
