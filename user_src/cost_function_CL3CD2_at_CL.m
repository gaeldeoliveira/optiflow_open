function sc = cost_function_CL3CD2_at_CL(parameters , experiments_results)
%function sc = sub_cost_function_CL3CD2_at_CL(aero_polar, cl_i , w_i)
%   Calculates weighted Cl3/Cd2 of a polar at Cl/Weight combinations from
...
for n_cl = 1:length(cl_i)
    ...
    if ~isnan(alpha_i)
        ...
        % Get Cl^3/Cd^2's
        cl3_cd2(n_cl) = cl_i(n_cl).^3 ./ cd_i(n_cl).^2;
    else
        ...
        if cl_i(n_cl) > ub_cl_range
            ...
            % Determine cl3_cd2 at equivalent angle of attack
            cl3_cd2(n_cl) = cl_alpha_equiv.^3 / cd_alpha_equiv.^2;
            ...
            cl3_cd2(n_cl) = cl3_cd2(n_cl) / penalty_factor;
        ...
        if cl_i(n_cl) < lb_cl_range
            ...
            cl3_cd2(n_cl) = lb_cl_range / cd_i(n_cl);
